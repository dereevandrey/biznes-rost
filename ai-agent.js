/**
 * Интерактивный AI-Агент «Территория Роста» (Сайт, виджет 2-в-1: Аудитор + Консьерж).
        ...
        <div id="prm-ai-modal">
            ...
            <div id="prm-body-audit" class="prm-body">
                <div class="prm-msg prm-msg-bot">
                    Введите <b>ИНН вашей компании</b>. Локальный AI-агент моментально проанализирует профиль и покажет 3 ключевые точки роста для внедрения ИИ-контура.
                </div>
